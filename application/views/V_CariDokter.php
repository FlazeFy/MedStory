                ...
                foreach ($Hospital as $data) {
                    echo "
                            ...
                            <section class='container-rujukan mb-3 mt-3'>
                                <!-- collapse -->
                                <button class='btn btn-primary bg-light text-dark font-weight-bold ' type='button' data-toggle='collapse' data-target='#collapse" . $i . "' aria-expanded='false' aria-controls='collapseExample'>
                                " . $data['nama'] . "
